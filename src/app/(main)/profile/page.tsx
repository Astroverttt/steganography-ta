...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center px-4 xl:px-8 space-y-6">
        {/* Upload Section - Only show if no artworks */}
        {artworks.length === 0 && (
          <div
            onClick={handleNavigateToUploadPage}
            className={clsx(
              "flex justify-center items-center w-full h-36 xl:h-80 border-2 border-dashed border-gray-500 rounded-xl overflow-hidden cursor-pointer transition-colors duration-200",
              !isButtonHovered && "hover:bg-gray-50 active:bg-gray-100"
            )}
          >
            <div className="flex flex-col items-center gap-4 px-5 py-6">
              ...
              <p className="hidden xl:block xl:text-sm text-center text-gray-600">
              ...
              <button
                ...
                className="mt-3 px-5 py-3 hidden xl:block xl:text-sm text-white bg-black rounded-full hover:bg-black/90 active:bg-black/80 transition duration-200 ease-in-out"
              >
                Upload your first shot
              </button>
            </div>
              ...
              {artworks.map((artwork) => (
                ...
                >
                  <Link href={`/home/detail-artwork/${artwork.id}`}>
                    <div className="relative w-full h-[180px] rounded-lg overflow-hidden shadow">
                      <Image
                        fill
